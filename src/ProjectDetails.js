...
const ProjectDetails = () => {
  ...
  return (
    <>
      <Nav />
      <div className="pt-40 px-5 md:px-14 lg:px-32">
        <div className="lg:grid grid-cols-2 gap-20">
          <div>
            <div className="flex gap-5 items-center">
              <div dangerouslySetInnerHTML={{ __html: project.icon }}></div>
              <div>
            ...
            <p className="text-sm pt-10 pb-10">{project.description}</p>

            <div className="flex gap-5">
              <a
                href="#"
                className="text-xs border-gray-600 border px-6 py-2 rounded-full
